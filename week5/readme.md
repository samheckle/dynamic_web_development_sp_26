...
[Randomly selected](https://editor.p5js.org/samheckle/sketches/aHz-w3biD).

## AMA

You should have all received your grades via google doc.

Questions / things to review at this time?
...
- https://claimyourpixel.online/
- Flexbox: [CSS Tricks](https://css-tricks.com/snippets/css/a-guide-to-flexbox/) | [Flexbox Froggy](https://flexboxfroggy.com/)
- Coding Train [ES6-ES8 Playlist](https://www.youtube.com/watch?v=q8SHaDQdul0&list=PLRqwX-V7Uu6YgpA3Oht-7B4NBQwFVe3pr)
